...
public class UserServiceImplTest {
  ...
  private static final List<User> testUsers = Arrays.asList(
      ...
      new User(2L, Collections.emptyList(), "Celine", "Monaghan", "celinee", "asdf1234"),
      new User(3L, Collections.emptyList(), "Ivor", "Andrew", "theandrews", "random64"),
      new User(4L, Collections.emptyList(), "Celine", "Fitzgerald", "fitzboss", "7jkj78f_s2")
  );
