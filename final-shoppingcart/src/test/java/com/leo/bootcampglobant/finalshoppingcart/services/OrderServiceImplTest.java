...
public class OrderServiceImplTest {
  ...
  private static final User testUser = new User(1L, Arrays.asList(
      new Order(1L, Arrays.asList(
          new OrderLine(1L, new Product(1L, new Category("TC1", "dtc1"),"Test Product 1", new BigDecimal("199.99")), 5),
          new OrderLine(2L, new Product(2L, new Category("TC2", "dtc2"), "Test Product 2", new BigDecimal("499.99")), 2),
          new OrderLine(3L, new Product(3L, new Category("TC3", "dtc3"),"Test Product 3", new BigDecimal("50.00")), 7)
      ), LocalDateTime.now()),
      new Order(2L, Arrays.asList(
          new OrderLine(4L, new Product(1L, new Category("TC1", "dtc1"),"Test Product 1", new BigDecimal("199.99")), 3),
          new OrderLine(5L, new Product(4L, new Category("TC4", "dtc4"),"Test Product 4", new BigDecimal("2.99")), 15)
          ), LocalDateTime.now())),
      "Test First Name", "Test Last Name", "testusername", "testpassword", "testemial@gmail.com"
  );
